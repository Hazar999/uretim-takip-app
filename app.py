...
def main():
    ...
    st.caption("İşçi çalışma süresi, POS, kombinasyon, adet ve fire bilgilerini kaydeder. — Sürüm 1.7 TAM")
    st.success("GÜNCEL SÜRÜM 1.7: Grafikler, Tümünü Seç, Yönetici Paneli ve Gün Sonu Kontrolü aktiftir.")

    with st.sidebar:
        st.header("Menü")
        st.info("Sürüm 1.7 TAM")
        page = st.radio("Sayfa", ["Yeni Kayıt", "Kayıtlar", "Grafikler", "Yönetici Paneli", "Gün Sonu Kontrolü", "Özet"], index=0)
        st.divider()
