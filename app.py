...
def main():
    ...
    st.caption("İşçi çalışma süresi, POS, kombinasyon, adet ve fire bilgilerini kaydeder. — Sürüm 2.7 KOMBİNASYON BAŞ HARFLERİ")
    if is_manager:
    ...
    with st.sidebar:
        st.header("Menü")
        st.info("Sürüm 2.7 KOMBİNASYON BAŞ HARFLERİ")
        manager_login_panel()
        if is_manager:
