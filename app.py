...
def apply_durlum_theme():
    """DURLUM FLOW için ihtişamlı fakat kontrollü, mimari ve kurumsal arayüz."""
    st.markdown(
        """
        <style>
        :root {
            ...
            --df-muted: #667C88;
            --df-success: #2F8C6A;
            --df-success-bg: #E0EFE8;
            --df-warning: #A66A20;
            --df-warning-bg: #F5EAD7;
            --df-danger: #B64C57;
            --df-danger-bg: #F3E2E4;
            --df-purple: #6E64A6;
            --df-purple-bg: #EAE7F4;
            --df-shadow: 0 18px 46px rgba(15, 43, 58, 0.12);
            --df-shadow-soft: 0 8px 22px rgba(15, 43, 58, 0.08);
        }
        ...
        .stApp {
            color: var(--df-text);
            background:
                radial-gradient(circle at 82% 0%, rgba(69, 184, 216, 0.18), transparent 29rem),
                radial-gradient(circle at 18% 92%, rgba(19, 143, 185, 0.11), transparent 34rem),
                linear-gradient(135deg, #D6E1E6 0%, #EEF3F5 45%, #DCE7EB 100%);
        }
        ...
        .stApp::before {
            ...
            opacity: 0.24;
            background-image:
                linear-gradient(120deg, transparent 0 58%, rgba(255,255,255,.62) 58% 58.5%, transparent 58.5% 100%),
                repeating-linear-gradient(
                    90deg,
                    rgba(16, 43, 58, 0.025) 0,
                    rgba(16, 43, 58, 0.025) 1px,
                    transparent 1px,
                    transparent 34px
                );
        ...
        [data-testid="stHeader"] {
            background: rgba(220, 230, 235, 0.88);
            border-bottom: 1px solid rgba(137, 160, 171, 0.35);
            backdrop-filter: blur(16px);
        }

        [data-testid="stSidebar"] {
            background:
                radial-gradient(circle at 20% 0%, rgba(69, 184, 216, 0.17), transparent 16rem),
                linear-gradient(180deg, #0A2B3E 0%, #0E3449 54%, #092738 100%);
            border-right: 1px solid rgba(142, 217, 233, 0.20);
            box-shadow: 16px 0 45px rgba(8, 35, 49, 0.17);
        }
        ...
        .sidebar-brand {
            ...
            border: 1px solid rgba(142, 217, 233, 0.22);
            border-radius: 15px;
        ...
        .sidebar-brand::after {
            ...
            top: -52px;
            border-radius: 50%;
            background: rgba(69, 184, 216, 0.18);
        }
        ...
        .sidebar-mark {
            ...
            border-radius: 11px;
            color: #FFFFFF;
            background: linear-gradient(145deg, #49BEDC, #087CA6);
            font-weight: 900;
            box-shadow: 0 10px 22px rgba(19, 143, 185, 0.28);
        }
        ...
        .sidebar-version {
            ...
            border-radius: 10px;
            color: #C8F2FC;
            background: rgba(69, 184, 216, 0.10);
            border: 1px solid rgba(142, 217, 233, 0.16);
            font-size: 0.76rem;
            font-weight: 720;
            text-align: center;
        }
        ...
        .durlum-header {
            ...
            overflow: hidden;
            display: grid;
            grid-template-columns: minmax(0, 1.4fr) minmax(350px, .8fr);
            align-items: stretch;
            min-height: 190px;
            margin: 0.05rem 0 0.85rem 0;
            border: 1px solid rgba(107, 144, 160, 0.36);
            border-radius: 24px;
            background:
                linear-gradient(115deg, #0A2A3C 0%, #123E56 48%, #0A2B3E 100%);
        ...
        .durlum-logo-box {
            ...
            border-radius: 18px;
            color: #FFFFFF;
            background: linear-gradient(145deg, #55C4DF 0%, #138FB9 55%, #096B91 100%);
            box-shadow:
        ...
        .durlum-eyebrow-dot {
            ...
            border-radius: 50%;
            background: #63D6B0;
            box-shadow: 0 0 12px rgba(99, 214, 176, .52);
        }
        ...
        .product-ribbon {
            ...
            border-radius: 999px;
            color: #D6F5FB;
            background: rgba(142, 217, 233, .10);
            border: 1px solid rgba(142, 217, 233, .22);
            font-size: .68rem;
            font-weight: 760;
            letter-spacing: .07em;
        }
        ...
        .durlum-role {
            ...
            border: 1px solid rgba(142,217,233,.2);
            font-size: .78rem;
            font-weight: 760;
        }
        ...
        .hero-art {
            ...
            overflow: hidden;
            background:
                radial-gradient(circle at 74% 16%, rgba(142,217,233,.22), transparent 18rem),
                linear-gradient(135deg, rgba(255,255,255,.02), rgba(255,255,255,.08));
            border-left: 1px solid rgba(142,217,233,.12);
        }
        ...
        .page-spotlight {
            ...
            border: 1px solid rgba(154, 177, 187, .42);
            border-radius: 14px;
            background:
                linear-gradient(125deg, rgba(255,255,255,.84), rgba(241,246,248,.86));
        ...
        [data-testid="stMetric"] {
            ...
            border-radius: 15px;
            background:
                linear-gradient(145deg, rgba(255,255,255,.91), rgba(238,244,247,.92));
            box-shadow: var(--df-shadow-soft);
        ...
        [data-testid="stMetric"]::before {
            ...
            inset: 0 auto 0 0;
            width: 4px;
            background: linear-gradient(180deg, var(--df-blue-2), var(--df-blue));
        }

        [data-testid="stMetric"]:hover {
            transform: translateY(-2px);
            box-shadow: 0 12px 28px rgba(15, 43, 58, 0.12);
        }
        ...
        [data-testid="stFormSubmitButton"] > button {
            ...
            color: #FFFFFF;
            background: linear-gradient(135deg, #25A5CC, #087EA7);
            box-shadow: 0 8px 18px rgba(19,143,185,.20);
            font-weight: 820;
        ...
        [data-testid="stFormSubmitButton"] > button:hover {
            ...
            box-shadow: 0 11px 24px rgba(19,143,185,.27);
        }
        ...
        [data-testid="stTextArea"] textarea {
            ...
            background: rgba(250,252,253,.95) !important;
        ...
        div[data-baseweb="textarea"] > div:focus-within {
            ...
            box-shadow: 0 0 0 2px rgba(19,143,185,.11) !important;
        }
        ...
        [data-testid="stTable"] {
            ...
            border: 1px solid var(--df-line);
            border-radius: 14px;
            background: rgba(250,252,253,.93);
            box-shadow: var(--df-shadow-soft);
        }
        ...
        [aria-selected="true"][data-baseweb="tab"] {
            ...
            background: linear-gradient(135deg, #2A9CC1, #147FA7);
        }
        ...
        [data-testid="stExpander"] {
            ...
            box-shadow: 0 5px 15px rgba(15,43,58,.045);
        }
        ...
        [data-testid="stFileUploaderDropzone"] {
            border: 1.5px dashed #93B7C6;
            border-radius: 13px;
            background:
                linear-gradient(135deg, rgba(229,240,245,.82), rgba(246,249,250,.88));
        }

        [data-testid="stProgressBar"] > div > div {
            background: linear-gradient(90deg, #138FB9, #62C4DF) !important;
        }
        ...
        [data-testid="stSidebar"] .stRadio label:hover {
            background: rgba(142,217,233,.09);
            transform: translateX(2px);
        }

        [data-testid="stSidebar"] .stRadio label:has(input:checked) {
            background: linear-gradient(90deg, rgba(69,184,216,.18), rgba(69,184,216,.04));
            border-color: rgba(142,217,233,.18);
            box-shadow: inset 3px 0 0 #65CEE5;
        }
        ...
        .wizard-shell {
            ...
            border-radius: 14px;
            background: rgba(220,230,235,.86);
        }
        ...
        .wizard-step {
            ...
            border-radius: 10px;
            color: #7B8F99;
            background: rgba(250,252,253,.46);
        }
        ...
        .wizard-step.active {
            ...
            border-color: #9FC7D7;
            box-shadow: inset 0 -3px 0 var(--df-blue);
        }
        ...
        .insight-card {
            border: 1px solid var(--df-line);
            background:
                linear-gradient(145deg, rgba(255,255,255,.88), rgba(237,243,246,.91));
            box-shadow: var(--df-shadow-soft);
        }
        ...
        .notification-card {
            ...
            border-radius: 10px;
            background: rgba(237,243,246,.84);
        }
        ...
        .empty-state {
            ...
            border-radius: 17px;
            background:
                radial-gradient(circle at 50% 0%, rgba(69,184,216,.11), transparent 12rem),
                rgba(246,249,250,.85);
        }
        ...
        .area-stage {
            display: grid;
            grid-template-columns: minmax(270px, .9fr) minmax(0, 1.45fr);
            gap: .85rem;
            margin: .25rem 0 1rem 0;
        }
        ...
        .area-blueprint {
            ...
            color: #EAF8FC;
            background:
                linear-gradient(rgba(142,217,233,.065) 1px, transparent 1px),
                linear-gradient(90deg, rgba(142,217,233,.065) 1px, transparent 1px),
                linear-gradient(145deg, #0A2D41, #123E56);
            background-size: 22px 22px, 22px 22px, auto;
            box-shadow: var(--df-shadow-soft);
        }

        .area-blueprint::after {
            content: "";
            position: absolute;
            width: 150px;
            height: 150px;
        ...
        .sheet-diagram {
            ...
            z-index: 1;
            height: 92px;
            margin: 1rem .55rem .85rem .55rem;
            border: 2px solid rgba(210,244,251,.78);
            background: linear-gradient(135deg, rgba(255,255,255,.05), rgba(142,217,233,.12));
            box-shadow: inset 0 0 0 7px rgba(142,217,233,.035);
        }
        ...
        .area-stat-card {
            ...
            border-radius: 14px;
            background:
                linear-gradient(145deg, rgba(255,255,255,.91), rgba(232,239,242,.92));
            box-shadow: var(--df-shadow-soft);
        }

        .area-stat-card::after {
            content: "";
            position: absolute;
            right: -22px;
            top: -28px;
        ...
        .completion-ring {
            ...
            border-radius: 50%;
            background:
                radial-gradient(circle at center, #F4F7F9 58%, transparent 59%),
                conic-gradient(var(--df-blue) var(--ring-value), #D6E1E6 0);
            color: var(--df-ink);
            font-size: .72rem;
            font-weight: 850;
        }
        ...
        .area-summary-item {
            ...
            border-radius: 14px;
            background:
                linear-gradient(145deg, rgba(230,240,244,.96), rgba(248,250,251,.95));
            box-shadow: var(--df-shadow-soft);
        }
        ...
        .area-summary-item::before {
            ...
            inset: 0 auto 0 0;
            width: 4px;
            background: linear-gradient(180deg, #4EB9D8, #148BB5);
        }
        ...
        /* SIDEBAR OKUNABİLİRLİK DÜZELTMESİ */
        [data-testid="stSidebar"] {
            color: #ECF8FC !important;
        }
        ...
        [data-testid="stSidebar"] hr {
            border-color: rgba(184, 225, 236, 0.28) !important;
        }
            ...
            <div class="durlum-hero-copy">
                ...
                <div>
                    <div class="durlum-eyebrow">
                        ...
                        ÜRETİM OPERASYON MERKEZİ
                    </div>
                    <div class="product-ribbon">
                        DURLUM FLOW · PRODUCTION INTELLIGENCE
                    </div>
                    <h1 class="durlum-title">
                        Operasyon <span>Kontrol</span> Sistemi
                    </h1>
                    <div class="durlum-subtitle">
                        Üretim akışını görünür, ölçülebilir ve yönetilebilir
                        hâle getiren dijital operasyon platformu
                    </div>
                    <div class="durlum-header-side">
                        <div class="durlum-role">{role_icon} {role}</div>
                        <div class="durlum-date">📅 {today_text} · Sistem aktif</div>
                    </div>
                </div>
            </div>
            <div class="hero-art" aria-hidden="true">
                <svg viewBox="0 0 520 240" preserveAspectRatio="xMidYMid slice">
                    <defs>
                        <linearGradient id="panelA" x1="0" x2="1">
                            <stop offset="0" stop-color="#8ED9E9" stop-opacity=".72"/>
                            <stop offset=".55" stop-color="#45B8D8" stop-opacity=".30"/>
                            <stop offset="1" stop-color="#FFFFFF" stop-opacity=".08"/>
                        </linearGradient>
                        <linearGradient id="panelB" x1="0" x2="1">
                            <stop offset="0" stop-color="#FFFFFF" stop-opacity=".10"/>
                            <stop offset="1" stop-color="#8ED9E9" stop-opacity=".34"/>
                        </linearGradient>
                        <filter id="blurGlow">
                            <feGaussianBlur stdDeviation="10"/>
                        </filter>
                    </defs>
                    <circle cx="390" cy="45" r="85" fill="#45B8D8" opacity=".12" filter="url(#blurGlow)"/>
                    <g transform="translate(10,-15) rotate(-10 260 120)">
                        <path d="M80 5 L145 5 L255 250 L190 250 Z" fill="url(#panelA)" opacity=".54"/>
                        <path d="M155 5 L220 5 L330 250 L265 250 Z" fill="url(#panelB)" opacity=".44"/>
                        <path d="M230 5 L295 5 L405 250 L340 250 Z" fill="url(#panelA)" opacity=".38"/>
                        <path d="M305 5 L370 5 L480 250 L415 250 Z" fill="url(#panelB)" opacity=".30"/>
                    </g>
                    <g fill="none" stroke="#BFEAF4" stroke-opacity=".26">
                        <path d="M30 205 C140 145 250 185 500 72" stroke-width="2"/>
                        <path d="M5 226 C125 162 278 202 525 92" stroke-width="1"/>
                        <path d="M120 236 C240 172 350 196 520 128" stroke-width="1"/>
                    </g>
                    <g fill="#D7F4FA" opacity=".48">
                        <circle cx="365" cy="92" r="3"/>
                        <circle cx="406" cy="72" r="2"/>
                        <circle cx="442" cy="55" r="2"/>
                    </g>
                </svg>
            </div>
        </div>
...
def render_page_spotlight(page: str):
    page_info = {
        "Demo Merkezi": (
            ...
            "Örnek grafikler, operasyon ilerlemeleri ve silinebilir demo kayıtlarıyla ürünü uçtan uca incele.",
        ),
        "Yeni Kayıt": (
            "✦",
            "Hızlı üretim girişi",
...
def render_demo_banner():
    st.markdown(
        ...
        <div class="demo-banner">
            <div><strong>◆ Demo Modu Aktif</strong><br>
            <span>Arayüz ve iş akışı denenebilir; hiçbir kayıt gerçek veritabanına yazılmaz.</span></div>
            <span class="status-pill purple">GÜVENLİ SUNUM</span>
        </div>
        ''',
        unsafe_allow_html=True,
    )
        ...
        notifications = [
            {
                "tone": "orange",
                "icon": "↘",
                "title": "Demo · POS30 kaynak yavaş",
                "copy": "Son kayıt hedef verimin %14 altında görünüyor.",
            },
            {
                "tone": "red",
                "icon": "!",
                "title": "Demo · Boya fire sınırı",
                "copy": "Boya firesi %5 sınırını aşarak %6,8 oldu.",
            },
            {
                "tone": "purple",
                "icon": "◷",
                "title": "Demo · Mesai kaydı",
                "copy": "3 çalışan bugün mesaili üretim kaydı oluşturdu.",
            },
            {
                "tone": "green",
                "icon": "✓",
                "title": "Demo · OC 940160",
                "copy": "Üretim planı %92 seviyesine ulaştı.",
            },
        ] + notifications
    ...
    for card in cards:
        html.append(
            ...
            <div class="insight-card">
                <div class="insight-icon">{card.get('icon', '•')}</div>
                <div class="insight-title">{card.get('title', '')}</div>
                <div class="insight-copy">{card.get('copy', '')}</div>
            </div>
            '''
        )
    html.append('</div>')
...
def make_demo_operation_history() -> pd.DataFrame:
    """İki OC, sekiz POS ve sekiz operasyon içeren ayrıntılı demo senaryosu."""
    ...
    pos_specs = [
        {
            "item_id": 7001,
            "OC": "940160",
            "project_name": "Illwerke Bregenz",
            "POS": "POS10",
            "requested_qty": 40,
            "unit_area_mm2": 1_009_715,
            "progress": 0.96,
        },
        {
            "item_id": 7002,
        ...
        },
        {
            ...
            "POS": "POS40",
            "requested_qty": 36,
            "unit_area_mm2": 1_145_600,
            "progress": 0.59,
        },
        {
            "item_id": 7005,
            "OC": "320159",
            "project_name": "NeoVac R -> Q",
            "POS": "POS50",
            "requested_qty": 24,
            "unit_area_mm2": 684_300,
            "progress": 0.46,
        },
        {
            "item_id": 7006,
    ...
    for spec_index, spec in enumerate(pos_specs):
        for operation_index, operation in enumerate(operations):
            stage_factor = max(spec["progress"] - operation_index * 0.045, 0.04)
            cumulative_good = min(
                int(spec["requested_qty"]),
                max(int(round(spec["requested_qty"] * stage_factor)), 1),
            )

            daily_base = cumulative_good // day_count
            daily_remainder = cumulative_good % day_count

            for day_index in range(day_count):
                good_qty = daily_base + (1 if day_index < daily_remainder else 0)
                if good_qty <= 0:
                    continue

                production_date = today - pd.Timedelta(days=day_count - 1 - day_index)
                worker_index = (
                    spec_index + operation_index + day_index
                ) % len(workers)
                operator_name = workers[worker_index]

                fire_qty = 0
                if (
                    (spec_index * 3 + operation_index + day_index) % 17 == 0
                    and operation in {"kaynak", "boya", "laser"}
                ):
                    fire_qty = 1

                processed_qty = good_qty + fire_qty
                batch_id = (
                    90_000
                    + day_index * 100
                    + worker_index * 10
                ...
                target_qty = 3.0 + operation_index * 0.22
                target_area = (
                    target_qty * float(spec["unit_area_mm2"])
                )
                ...
                rows.append(
                    {
                        ...
                        "tarih": str(production_date.date()),
                        "operator_ismi": operator_name,
                        "calisma_tipi": (
                            "Mesaili"
                            if day_index == day_count - 1
                            and worker_index in {0, 2}
                            else "Tam zamanlı"
                        ),
                        "calisma_saati": (
                            10.5
                        ...
                        "POS": str(spec["POS"]),
                        "requested_qty": int(spec["requested_qty"]),
                        "combination_name": combination_name,
                        "operation_order": operation_index + 1,
                        "operasyon": operation,
                        "islem_yapilan": int(processed_qty),
                        "fire": int(fire_qty),
                        "saglam_ilerleyen": int(good_qty),
                        "unit_area_mm2": float(spec["unit_area_mm2"]),
                        "saglam_alan_mm2": (
                            int(good_qty) * float(spec["unit_area_mm2"])
                        ),
                        "islenen_alan_mm2": (
                            int(processed_qty) * float(spec["unit_area_mm2"])
                        ),
                        "hedef_adet_saat": float(target_qty),
                        "hedef_mm2_saat": float(target_area),
                        "fire_siniri_yuzde": (
                            3.0 if operation == "boya" else 5.0
                        ),
                        "yavas_siniri_yuzde": 80.0,
                        "hizli_siniri_yuzde": 120.0,
                        "fire_notu": (
                            f"Fire etabı: {operation} | Demo kalite kontrol kaydı"
                            if fire_qty
                            else ""
                        ),
                        "notlar": "Demo senaryosu",
                        "created_at": str(production_date),
                    }
                )
...
def initialize_demo_data(force: bool = False):
    """Demo verilerini yalnızca oturum belleğinde hazırlar."""
    if force or "demo_operation_history" not in st.session_state:
        st.session_state.demo_operation_history = (
            make_demo_operation_history()
        )
        st.session_state.demo_last_action = (
            "Ayrıntılı demo senaryosu yüklendi."
        )


def get_demo_operation_history() -> pd.DataFrame:
...
def clear_demo_data(remove_key: bool = False):
    """Demo kayıtlarını gerçek veritabanına dokunmadan temizler."""
    if remove_key:
        st.session_state.pop("demo_operation_history", None)
    else:
        st.session_state.demo_operation_history = pd.DataFrame()
    st.session_state.demo_last_action = "Demo kayıtları temizlendi."
...
def delete_demo_batch(batch_id: int) -> int:
    history = get_demo_operation_history()
    if history.empty:
        return 0

    before = len(history)
    history = history[
        history["batch_id"].astype(int) != int(batch_id)
    ].copy()
    deleted = before - len(history)
    st.session_state.demo_operation_history = history
    st.session_state.demo_last_action = (
        f"Demo kayıt #{int(batch_id)} silindi."
    )
    return int(deleted)


def append_demo_operation_batch(
    production_date,
    operator_name: str,
    work_type: str,
    work_hours: float,
    ...
    """Yeni Kayıt sihirbazındaki demo kaydını demo grafiklerine ekler."""
    history = get_demo_operation_history()

    if history.empty:
        batch_id = 99_001
    else:
        batch_id = int(history["batch_id"].max()) + 1
    ...
    for operation_index, entry in enumerate(entries, start=1):
        ...
        target = target_map.get(
            operation_name,
            {
                "target_qty_per_hour": 3.0,
                "target_area_per_hour": (
                    3.0 * float(entry.get("unit_area_mm2", 0))
                ),
                "fire_limit_pct": 5.0,
                "slow_limit_pct": 80.0,
                "fast_limit_pct": 120.0,
        ...
        requested_qty = int(
            entry.get(
                "requested_qty",
                int(entry.get("remaining_before", 0))
                + int(entry.get("good_qty", 0)),
            )
        )
        ...
        rows.append(
            {
                ...
                "operator_ismi": str(operator_name),
                "calisma_tipi": str(work_type),
                "calisma_saati": float(work_hours),
                "OC": str(selected_oc),
                "project_name": "Demo sırasında oluşturulan kayıt",
                "POS": str(entry["pos"]),
                "requested_qty": requested_qty,
                "combination_name": "DEMO",
                "operation_order": operation_index,
                "operasyon": operation_name,
                "islem_yapilan": int(entry["processed_qty"]),
                "fire": int(entry["fire_qty"]),
                "saglam_ilerleyen": int(entry["good_qty"]),
                "unit_area_mm2": float(
                    entry.get("unit_area_mm2", 0)
                ),
                "saglam_alan_mm2": (
                    int(entry["good_qty"])
                    * float(entry.get("unit_area_mm2", 0))
                ...
                "islenen_alan_mm2": (
                    int(entry["processed_qty"])
                    * float(entry.get("unit_area_mm2", 0))
                ),
                "hedef_adet_saat": float(
                    target.get("target_qty_per_hour", 0)
                ),
                "hedef_mm2_saat": float(
                    target.get("target_area_per_hour", 0)
                ),
                "fire_siniri_yuzde": float(
                    target.get("fire_limit_pct", 5)
                ),
                "yavas_siniri_yuzde": float(
                    target.get("slow_limit_pct", 80)
                ),
                "hizli_siniri_yuzde": float(
                    target.get("fast_limit_pct", 120)
                ),
                "fire_notu": str(entry.get("fire_note", "")),
                "notlar": str(note or "Demo sırasında oluşturuldu"),
    ...
    st.session_state.demo_operation_history = combined
    st.session_state.demo_last_action = (
        f"Demo kayıt #{batch_id} oluşturuldu."
    )
    return batch_id


def make_demo_overview(
    history: pd.DataFrame | None = None,
) -> pd.DataFrame:
    """Demo işlem geçmişinden POS bazlı güncel durum üretir."""
    if history is None:
        history = get_demo_operation_history()
    if history.empty:
        return pd.DataFrame()
    ...
    for group_values, group in history.groupby(
        group_columns,
        dropna=False,
    ):
        (
        ...
        totals = (
            group.groupby("operasyon", as_index=False)
            .agg(
                completed_qty=("saglam_ilerleyen", "sum"),
                processed_qty=("islem_yapilan", "sum"),
                fire_qty=("fire", "sum"),
            )
        )
        totals_map = dict(
            zip(
                totals["operasyon"].astype(str),
                totals["completed_qty"].astype(int),
            )
        )
        planned_operations = [
            operation
            for operation in operation_order
            if operation in totals_map
        ]
        if not planned_operations:
            planned_operations = totals["operasyon"].astype(str).tolist()

        stage_values = [
            min(int(totals_map.get(operation, 0)), int(requested_qty))
            for operation in planned_operations
        ]
        produced_qty = min(stage_values) if stage_values else 0
        max_stage = max(stage_values) if stage_values else 0
        in_production_qty = max(max_stage - produced_qty, 0)
        remaining_qty = max(int(requested_qty) - produced_qty, 0)
        operation_fire_qty = int(totals["fire_qty"].sum())
        completion_pct = (
            produced_qty / int(requested_qty) * 100
            if int(requested_qty) > 0
            else 0.0
        )
        ...
        rows.append(
            {
                ...
                "in_production_qty": int(in_production_qty),
                "remaining_qty": int(remaining_qty),
                "operation_fire_qty": int(operation_fire_qty),
                "completion_pct": round(float(completion_pct), 1),
                "unit_area_mm2": float(unit_area_mm2),
            }
        )
...
def make_demo_progress(
    ...
    item_history = history[
        history["item_id"].astype(int) == int(item_id)
    ].copy()
    if item_history.empty:
        return pd.DataFrame()

    requested_qty = int(item_history["requested_qty"].iloc[0])
    operation_order = {
        "laser": 1,
        "abkant": 2,
        "çıta": 3,
    ...
    progress = (
        item_history.groupby("operasyon", as_index=False)
        .agg(
            completed_qty=("saglam_ilerleyen", "sum"),
            processed_qty=("islem_yapilan", "sum"),
            fire_qty=("fire", "sum"),
    ...
    progress["operation_order"] = progress["operasyon"].map(
        operation_order
    ).fillna(99).astype(int)
    progress["requested_qty"] = requested_qty
    progress["completed_qty"] = progress[
        "completed_qty"
    ].clip(upper=requested_qty).astype(int)
    progress["remaining_qty"] = (
        requested_qty - progress["completed_qty"]
    ).clip(lower=0)
    ...
    progress = progress.rename(
        columns={"operasyon": "operation_name"}
    )

    return progress.sort_values("operation_order").reset_index(
        drop=True
    )


def make_demo_batch_summary(
    history: pd.DataFrame | None = None,
) -> pd.DataFrame:
    if history is None:
        history = get_demo_operation_history()
    ...
    batches = (
        ...
        .agg(
            ...
            islem_satiri=("operasyon", "count"),
            notlar=("notlar", "first"),
            created_at=("created_at", "first"),
            fire_limit_pct=("fire_siniri_yuzde", "mean"),
        )
    )

    batches["adet_saat"] = (
        batches["saglam_ilerleyen"]
        / batches["calisma_saati"].replace(0, 1)
    ).round(2)
    batches["mm2_saat"] = (
        batches["saglam_alan_mm2"]
        / batches["calisma_saati"].replace(0, 1)
    ).round(2)
    batches["fire_yuzde"] = (
        batches["fire"]
        / batches["islem_yapilan"].replace(0, 1)
        * 100
    ).round(2)

    median_qty = float(batches["adet_saat"].median())
    batches["verim_skoru_yuzde"] = (
        batches["adet_saat"]
        / max(median_qty, 0.0001)
        * 100
    ).round(1)
    batches["gidisat"] = batches[
        "verim_skoru_yuzde"
    ].apply(
        lambda score: (
            "Yavaş"
    ...
    batches["verim_referansi"] = "Demo medyanı"
    batches["fire_durumu"] = batches.apply(
        lambda row: (
            "Sınır Aşıldı"
            if float(row["fire_yuzde"])
            > float(row["fire_limit_pct"])
            else "Normal"
        ),
        axis=1,
    )

    return batches.sort_values(
        ["tarih", "batch_id"],
        ascending=[False, False],
    ).reset_index(drop=True)


def demo_merkezi_page():
    st.subheader("Demo Merkezi")
    st.caption(
        "Ürün sunumu için hazırlanmış ayrıntılı senaryo. "
        "Bütün kayıtlar yalnızca bu tarayıcı oturumunda tutulur."
    )

    history = get_demo_operation_history()
    last_action = st.session_state.pop(
        "demo_last_action",
        None,
    )
    if last_action:
        st.success(last_action)

    if history.empty:
        render_empty_state(
            "Demo kayıtları temizlendi",
            "Ayrıntılı örnek üretim senaryosunu yeniden yükleyerek "
            "grafikleri, kayıtları ve operasyon takibini inceleyebilirsin.",
            "◆",
        )
        if st.button(
            "Ayrıntılı Demo Senaryosunu Yükle",
            type="primary",
            use_container_width=True,
        ):
            reset_demo_data()
    ...
    overview = make_demo_overview(history)
    batches = make_demo_batch_summary(history)
    ...
    with tabs[0]:
        ...
        total_fire = int(history["fire"].sum())
        total_area = float(history["saglam_alan_mm2"].sum())
        worker_count = int(history["operator_ismi"].nunique())
        batch_count = int(history["batch_id"].nunique())

        m1, m2, m3, m4 = st.columns(4)
        m1.metric("Demo kayıt sayısı", batch_count)
        m2.metric("Çalışan", worker_count)
        m3.metric("Tam biten", f"{total_completed} / {total_requested}")
        m4.metric("Operasyon firesi", total_fire)

        m5, m6, m7, m8 = st.columns(4)
        m5.metric("OC", int(overview["oc_no"].nunique()))
        m6.metric("POS", int(overview["pos"].nunique()))
        m7.metric("Sağlam alan", f"{_format_m2(total_area)} m²")
        m8.metric(
            "Genel tamamlanma",
            (
                f"%{total_completed / total_requested * 100:.1f}"
                if total_requested
                else "%0"
            ),
        )

        st.write("Demo POS durumu")
        st.dataframe(
            overview[
                [
                    "oc_no",
        ...
        near_complete = overview[
            (overview["completion_pct"] >= 80)
            & (overview["completion_pct"] < 100)
        ]
        completed = overview[overview["completion_pct"] >= 100]
        slow = overview.sort_values("completion_pct").head(1)

        cards = [
            {
                "icon": "◎",
                "title": "Tamamlanmaya yakın",
                "copy": (
                    f"{len(near_complete)} POS %80 seviyesinin üzerinde."
                    if not near_complete.empty
                    else "Tamamlanmaya yakın POS bulunmuyor."
                ),
            },
            {
                "icon": "✓",
                "title": "Tamamlanan POS",
                "copy": f"{len(completed)} POS bütün etaplardan geçti.",
            },
            {
                "icon": "↘",
                "title": "En gerideki POS",
                "copy": (
                    f"{slow.iloc[0]['pos']} · "
                    f"%{float(slow.iloc[0]['completion_pct']):.1f}"
                    if not slow.empty
                    else "Veri yok"
                ),
            },
            {
                "icon": "◷",
                "title": "Mesai senaryosu",
                "copy": (
                    f"{history[history['calisma_tipi'] == 'Mesaili']['batch_id'].nunique()} "
                    "mesaili demo kaydı bulunuyor."
                ),
            },
        ]
    ...
    with tabs[1]:
        ...
        history_chart["tarih_dt"] = pd.to_datetime(
            history_chart["tarih"],
            errors="coerce",
        )
        ...
        daily = (
            history_chart.groupby("tarih_dt", as_index=False)
            .agg(
        ...
        daily["adet_saat"] = (
            daily["sağlam_ilerleyen"]
            / daily["çalışma_saati"].replace(0, 1)
        ).round(2)
        daily["mm2_saat"] = (
            daily["sağlam_alan_mm2"]
            / daily["çalışma_saati"].replace(0, 1)
        ).round(2)
        daily["fire_yüzde"] = (
            daily["fire"]
            / daily["işlem_yapılan"].replace(0, 1)
            * 100
        ).round(2)

        st.write("Günlük sağlam üretim ve işlem yükü")
        st.line_chart(
            daily.set_index("tarih_dt")[
                ["sağlam_ilerleyen", "işlem_yapılan"]
            ]
        )
        ...
        with c1:
            st.write("Adet / saat")
            st.area_chart(
                daily.set_index("tarih_dt")[["adet_saat"]]
            )
        with c2:
            st.write("Alan verimi · mm² / saat")
            st.area_chart(
                daily.set_index("tarih_dt")[["mm2_saat"]]
            )

        operation_summary = (
            history_chart.groupby("operasyon", as_index=False)
            .agg(
                sağlam=("saglam_ilerleyen", "sum"),
                işlem_yapılan=("islem_yapilan", "sum"),
                fire=("fire", "sum"),
                sağlam_alan=("saglam_alan_mm2", "sum"),
        ...
        operation_summary["fire_yüzde"] = (
            ...
            / operation_summary["işlem_yapılan"].replace(0, 1)
            * 100
        ).round(2)

        worker_summary = (
            history_chart.groupby("operator_ismi", as_index=False)
            .agg(
                sağlam=("saglam_ilerleyen", "sum"),
                fire=("fire", "sum"),
                POS=("POS", "nunique"),
            ...
            .sort_values("sağlam", ascending=False)
        )

        c3, c4 = st.columns(2)
        with c3:
            st.write("Operasyon bazlı üretim")
            st.bar_chart(
        ...
        with c4:
            st.write("Çalışan bazlı iş dağılımı")
            st.bar_chart(
                worker_summary.set_index("operator_ismi")[
                    ["sağlam", "fire"]
                ]
            )

        st.write("Fire oranı ve tanımlı sınır")
        st.bar_chart(
            operation_summary.set_index("operasyon")[
                ["fire_yüzde", "fire_sınırı"]
            ]
        )

        st.write("POS tamamlanma oranları")
        st.bar_chart(
            overview.set_index("pos")[["completion_pct"]]
        )

    with tabs[2]:
        oc_options = sorted(
            overview["oc_no"].astype(str).unique().tolist()
        )
        ...
        oc_rows = overview[
            overview["oc_no"].astype(str) == selected_oc
        ]
        selected_pos = st.selectbox(
            "Demo POS",
            oc_rows["pos"].astype(str).tolist(),
            key="demo_center_pos",
        )
        item_row = oc_rows[
            oc_rows["pos"].astype(str) == selected_pos
        ].iloc[0]
        item_id = int(item_row["item_id"])

        p1, p2, p3, p4 = st.columns(4)
        p1.metric("İstenen", int(item_row["requested_qty"]))
        p2.metric("Tam biten", int(item_row["produced_qty"]))
        p3.metric(
            "Üretimde olan",
            int(item_row["in_production_qty"]),
        )
        p4.metric(
            "Tamamlanma",
            f"%{float(item_row['completion_pct']):.1f}",
        )

        progress = make_demo_progress(item_id, history)
        st.dataframe(
            progress[
                [
                    "operation_order",
        ...
        st.bar_chart(
            progress.set_index("operation_name")[
                ["completed_qty", "remaining_qty", "fire_qty"]
            ]
        )

        item_history = history[
            history["item_id"].astype(int) == item_id
        ].copy()
        st.write("Seçilen POS işlem geçmişi")
        st.dataframe(
            item_history[
                [
                    "tarih",
    ...
    with tabs[3]:
        ...
        selected_label = st.selectbox(
            "Ayrıntısı görüntülenecek demo kaydı",
            labels,
            key="demo_record_select",
        )
        selected_index = labels.index(selected_label)
        selected_batch = batches.iloc[selected_index]
        selected_batch_id = int(selected_batch["batch_id"])

        detail = history[
            history["batch_id"].astype(int) == selected_batch_id
        ].copy()
        st.dataframe(
            detail[
                [
        ...
        st.warning(
            "Bu silme işlemi yalnızca demo oturumundaki kaydı kaldırır. "
            "Gerçek veritabanına dokunulmaz."
        )
        confirm_delete = st.checkbox(
            "Seçili demo kaydını silmek istediğimi onaylıyorum",
            key=f"demo_delete_confirm_{selected_batch_id}",
        )
        if st.button(
            "Seçili Demo Kaydını Sil",
            type="primary",
            disabled=not confirm_delete,
            key=f"demo_delete_button_{selected_batch_id}",
        ):
            deleted_rows = delete_demo_batch(selected_batch_id)
            st.success(
                f"Demo kayıt #{selected_batch_id} silindi. "
                f"{deleted_rows} işlem satırı kaldırıldı."
            )
            st.rerun()

    with tabs[4]:
        st.info(
            "Demo kayıtları SQLite veritabanına yazılmaz. "
            "Demo Modu kapatıldığında otomatik olarak temizlenir."
        )

        d1, d2 = st.columns(2)
        with d1:
            if st.button(
                "Demo Senaryosunu Baştan Yükle",
                type="primary",
                use_container_width=True,
                key="demo_reset_full",
            ):
        ...
        st.write("Demo veri güvenliği")
        safety = pd.DataFrame(
            [
                {
                    "Özellik": "Gerçek veritabanına yazma",
                    "Durum": "Kapalı",
                },
                {
                    "Özellik": "Demo kaydını tek tek silme",
                    "Durum": "Açık",
                },
                {
                    "Özellik": "Tüm demo kayıtlarını temizleme",
                    "Durum": "Açık",
                },
                {
                    "Özellik": "Demo modu kapanınca otomatik silme",
                    "Durum": "Açık",
                },
                {
                    "Özellik": "Grafik ve rapor inceleme",
                    "Durum": "Açık",
                },
            ]
        )
...
def main():
    ...
    st.caption("Sürüm 2.12.5 AYRINTILI DEMO MERKEZİ · İşçi, OC, POS, işlem, adet, fire ve yetkinlik takibi")
    if is_manager:
    ...
    with st.sidebar:
        st.markdown(
            ...
            <div class="sidebar-version">
                Sürüm 2.12.5 · AYRINTILI DEMO MERKEZİ
            </div>
            """,
            unsafe_allow_html=True,
        )
        ...
        previous_demo_mode = bool(
            st.session_state.get("_previous_demo_mode", False)
        )
        demo_enabled = st.checkbox(
            ...
            key="demo_mode",
            help=(
                "Ayrıntılı örnek kayıtları, grafikleri ve operasyon "
                "takibini gerçek veritabanına dokunmadan incele."
            ),
        )

        if previous_demo_mode and not demo_enabled:
            clear_demo_data(remove_key=True)
            st.session_state.demo_cleanup_notice = (
                "Demo kapatıldı; oturumdaki bütün demo kayıtları silindi."
            )

        st.session_state._previous_demo_mode = bool(demo_enabled)

        if demo_enabled:
            initialize_demo_data()
            st.caption(
                "◆ Güvenli sunum modu · Demo kayıtları kapatınca otomatik silinir."
            )
            demo_control_1, demo_control_2 = st.columns(2)
            with demo_control_1:
                if st.button(
                    "Yenile",
                    key="sidebar_demo_reset",
                    use_container_width=True,
                ):
                    reset_demo_data()
                    st.rerun()
            with demo_control_2:
                if st.button(
                    "Sil",
                    key="sidebar_demo_clear",
                    use_container_width=True,
                ):
                    clear_demo_data()
                    st.rerun()

        cleanup_notice = st.session_state.pop(
            "demo_cleanup_notice",
            None,
        )
        if cleanup_notice:
        ...
        current_demo_mode = bool(
            st.session_state.get("demo_mode", False)
        )
        if current_demo_mode:
            worker_pages = ["Demo Merkezi"] + worker_pages
            manager_pages = ["Demo Merkezi"] + manager_pages
    ...
    if page == "Demo Merkezi" and st.session_state.get("demo_mode", False):
        demo_merkezi_page()
    elif page == "Yeni Kayıt":
        if not combinations:
...
def yeni_kayit_page(reasons, combinations, is_manager: bool):
    ...
    with b1:
        if st.button("← Düzenlemeye Dön", use_container_width=True):
            go_to(4)
    with b2:
        save_label = "Demo Kaydını Tamamla ✓" if st.session_state.get("demo_mode", False) else "Kaydı Onayla ve Tamamla ✓"
        if st.button(
            save_label,
            type="primary",
            use_container_width=True,
            ...
            if st.session_state.get("demo_mode", False):
                demo_batch_id = append_demo_operation_batch(
                    production_date=production_date,
                    operator_name=operator_name.strip(),
                    work_type=work_type,
                    work_hours=float(work_hours),
                    selected_oc=str(selected_oc),
                    entries=entries,
                    note=note,
                )
                st.session_state.operation_form_version = version + 1
                st.session_state.operation_entry_success = (
                    f"Demo kayıt #{demo_batch_id} oluşturuldu. "
                    f"{len(entries)} POS/işlem satırı Demo Merkezi ve "
                    "Grafikler sayfasına eklendi; gerçek veritabanına yazılmadı."
                )
                st.rerun()
...
def grafikler_page():
    ...
    history = (
        get_demo_operation_history()
        if using_demo
        else get_operation_history()
    )
    ...
    if history.empty:
        ...
        overview = (
            make_demo_overview(history)
            if using_demo
            else get_operation_overview()
        )
        ...
        with t2:
            ...
            operation_perf["hedef_karşılama_%"] = (
                operation_perf["gerçek_adet_saat"]
                / operation_perf["hedef_adet_saat"].replace(0, pd.NA)
                * 100
            ).round(1)
            st.dataframe(
                operation_perf[
            ...
            if not below.empty:
                ...
                st.success("Tanımlı hedeflerin altında kritik bir operasyon görünmüyor.")
