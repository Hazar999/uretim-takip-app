...
def main():
    ...
    st.caption("Sürüm 2.14.0 · CUT OUT ADET / KİŞİ-GÜN m² / BOYA VERİMİ")
    st.markdown(
        """
        ...
        ✓ AKTİF SÜRÜM 2.15.0 — HER ETAPTA m² · Lazer çoklu plaka grubu · Kurumsal grafik paneli
        </div>
        """,
        unsafe_allow_html=True,
    )
    ...
    with st.sidebar:
        st.markdown(
            ...
            <div class="sidebar-version">
                Sürüm 2.14.0 · CUT OUT ADET / m² DASHBOARD
            </div>
            """,
            unsafe_allow_html=True,
        )
