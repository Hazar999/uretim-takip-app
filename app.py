...
def render_pos_area_overview(
    ...
    st.markdown(
        ...
        <div class="area-overview">
            <div class="area-overview-item">
                <div class="area-overview-label">Ölçü</div>
                <div class="area-overview-value">
                    {_format_mm2(boy_mm)} × {_format_mm2(en_mm)} mm
                </div>
                <div class="area-overview-detail">Boy × En</div>
            </div>
            <div class="area-overview-item">
                <div class="area-overview-label">Birim alan</div>
                <div class="area-overview-value">{_format_m2(unit_area_mm2)} m²</div>
                <div class="area-overview-detail">
                    {_format_mm2(unit_area_mm2)} mm²
                </div>
            </div>
            <div class="area-overview-item">
                <div class="area-overview-label">İstenen toplam alan</div>
                <div class="area-overview-value">
                    {_format_m2(requested_area_mm2)} m²
                </div>
                <div class="area-overview-detail">
                    {requested_qty} adet için
                </div>
            </div>
            <div class="area-overview-item">
                <div class="area-overview-label">Tam biten</div>
                <div class="area-overview-value">
                    {int(completed_qty)} / {int(requested_qty)}
                </div>
                <div class="area-overview-detail">
                    Kalan {max(int(requested_qty) - int(completed_qty), 0)} adet
                </div>
            </div>
        </div>
        """,
        ...
        <div class="area-summary">
            <div class="area-summary-item">
                ...
                <div class="area-summary-detail">
                    {_format_mm2(good_area_mm2)} mm²
                </div>
            </div>
            <div class="area-summary-item">
                <div class="area-summary-label">Alan verimi</div>
                <div class="area-summary-value">{_format_m2(area_per_hour)} m²/saat</div>
                <div class="area-summary-detail">
                    {_format_mm2(area_per_hour)} mm²/saat
                </div>
            </div>
            <div class="area-summary-item">
                ...
                <div class="area-summary-detail">
                    İşlenen toplam: {_format_m2(processed_area_mm2)} m²
                </div>
            </div>
        </div>
        """,
...
def apply_durlum_theme():
    """Durlum renkleriyle sade, ferah ve uzun kullanımda gözü yormayan arayüz."""
    st.markdown(
        """
        <style>
        :root {
            ...
            --d-bg: #F4F7F9;
            --d-surface: #FFFFFF;
            --d-surface-alt: #F8FAFB;
            --d-line: #DDE7EC;
            --d-line-strong: #C8D9E1;
            --d-success: #23986C;
            --d-success-bg: #EAF8F2;
            --d-warning: #B7791F;
            --d-warning-bg: #FFF6E6;
            ...
            --d-purple: #7067B5;
            --d-purple-bg: #F1F0FB;
            --d-shadow: 0 4px 16px rgba(28, 61, 78, 0.07);
            --d-shadow-soft: 0 2px 8px rgba(28, 61, 78, 0.05);
        }
        ...
        [data-testid="stSidebar"] {
            ...
            box-shadow: 4px 0 18px rgba(28, 61, 78, 0.04);
        }
        ...
        div[data-baseweb="textarea"] > div:focus-within {
            ...
            box-shadow: 0 0 0 2px rgba(0, 143, 196, 0.10) !important;
        }
        ...
        [data-testid="stSidebar"] .stRadio label:has(input:checked) {
            ...
            color: var(--d-blue-dark) !important;
        }
        ...
        .wizard-step.active {
            ...
            background: #FFFFFF;
            border-color: #A8D5E5;
            box-shadow: inset 0 -3px 0 var(--d-blue);
        }
...
def apply_comfort_theme():
    """Saf beyazı ve sert kontrastı azaltan dengeli Durlum arayüzü."""
    st.markdown(
        """
        <style>
        :root {
            --comfort-bg: #E8EEF2;
            --comfort-sidebar: #DEE7EC;
            --comfort-surface: #F3F6F8;
            --comfort-surface-2: #EDF3F6;
            --comfort-input: #F8FAFB;
            --comfort-line: #C9D7DF;
            --comfort-text: #263A47;
            --comfort-muted: #667C88;
            --comfort-blue: #2B7F9D;
            --comfort-blue-dark: #236A84;
            --comfort-blue-soft: #DCECF2;
            --comfort-success: #317C62;
            --comfort-warning: #A66E24;
            --comfort-danger: #B64F59;
            --comfort-purple: #6F679A;
        }
        ...
        [data-testid="stHeader"] {
            background: rgba(232, 238, 242, 0.94) !important;
            border-bottom: 1px solid var(--comfort-line) !important;
        }

        [data-testid="stSidebar"] {
            background: var(--comfort-sidebar) !important;
            border-right: 1px solid #C4D2DA !important;
            box-shadow: none !important;
        }
        ...
        [data-testid="stExpander"] {
            ...
            box-shadow: 0 2px 7px rgba(38, 58, 71, 0.045) !important;
        }

        .durlum-header {
            border-left-color: var(--comfort-blue) !important;
        }

        .durlum-logo-box,
        .sidebar-mark {
            background: var(--comfort-blue) !important;
            box-shadow: none !important;
        }
        ...
        .sidebar-version,
        .page-spotlight-icon {
            color: var(--comfort-blue-dark) !important;
        }
        ...
        .product-ribbon {
            color: var(--comfort-blue-dark) !important;
            background: var(--comfort-blue-soft) !important;
        ...
        [data-testid="stFormSubmitButton"] > button {
            color: #FFFFFF !important;
            background: var(--comfort-blue) !important;
            border-color: var(--comfort-blue) !important;
            box-shadow: none !important;
        ...
        [data-testid="stFormSubmitButton"] > button:hover {
            color: #FFFFFF !important;
            background: var(--comfort-blue-dark) !important;
            border-color: var(--comfort-blue-dark) !important;
            transform: none !important;
        }
        ...
        [data-testid="stTextArea"] textarea {
            color: var(--comfort-text) !important;
            background: var(--comfort-input) !important;
            border-color: #BFCFD7 !important;
            box-shadow: none !important;
        }
        ...
        .wizard-step.active {
            color: var(--comfort-blue-dark) !important;
            background: var(--comfort-surface) !important;
            border-color: #AFC8D4 !important;
            box-shadow: inset 0 -3px 0 var(--comfort-blue) !important;
        }

        .wizard-step {
            background: rgba(243, 246, 248, 0.68) !important;
        }

        .wizard-step.done {
            color: var(--comfort-success) !important;
            background: #DDECE6 !important;
            border-color: #BED8CC !important;
        }

        [data-testid="stSidebar"] .stRadio label:hover,
        [data-testid="stSidebar"] .stRadio label:has(input:checked) {
            background: rgba(243, 246, 248, 0.72) !important;
            border-color: #BFCDD5 !important;
            box-shadow: inset 3px 0 0 var(--comfort-blue) !important;
        }
        ...
        .completed-state {
            color: var(--comfort-success) !important;
            background: #DFEDE7 !important;
            border-color: #BCD7CB !important;
        }

        .status-pill.orange {
            color: var(--comfort-warning) !important;
            background: #F2E8D7 !important;
            border-color: #DDC8A4 !important;
        }

        .status-pill.red {
            color: var(--comfort-danger) !important;
            background: #F1E1E3 !important;
            border-color: #DDBFC3 !important;
        }

        .status-pill.purple,
        .demo-banner {
            color: var(--comfort-purple) !important;
            background: #E7E4F0 !important;
            border-color: #CBC5DF !important;
        }
...
def main():
    ...
    st.caption("Sürüm 2.12.3 DENGELİ ARAYÜZ + FIRE ETABI · İşçi, OC, POS, işlem, adet, fire ve yetkinlik takibi")
    if is_manager:
    ...
    with st.sidebar:
        st.markdown(
            ...
            <div class="sidebar-version">
                Sürüm 2.12.3 · DENGELİ ARAYÜZ + FIRE ETABI
            </div>
            """,
            unsafe_allow_html=True,
        )
