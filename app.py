...
def apply_durlum_theme():
    """DURLUM FLOW için mesh, metal ve mimari grid ilhamlı premium arayüz."""
    st.markdown(
        """
        <style>
        :root {
            ...
            --df-muted: #6B818C;
            --df-success: #257D67;
            --df-success-bg: #E0F0EA;
            --df-warning: #A66A20;
            --df-warning-bg: #F7ECD8;
            --df-danger: #BA5562;
            --df-danger-bg: #F6E3E7;
            --df-purple: #6D66A8;
            --df-purple-bg: #ECE8F7;
            --df-shadow: 0 20px 50px rgba(10, 42, 58, 0.14);
            --df-shadow-soft: 0 10px 28px rgba(10, 42, 58, 0.08);
            --df-glow: 0 0 0 1px rgba(255,255,255,.42) inset, 0 16px 34px rgba(10, 42, 58, 0.10);
        }
        ...
        .stApp {
            color: var(--df-text);
            background:
                radial-gradient(circle at 16% 0%, rgba(63,183,214,.16), transparent 28rem),
                radial-gradient(circle at 90% 8%, rgba(118,200,185,.12), transparent 24rem),
                radial-gradient(circle at 22% 100%, rgba(15,136,179,.10), transparent 34rem),
                linear-gradient(135deg, #DFE7EA 0%, #F5F9FA 46%, #E2EAED 100%);
        }
        ...
        .stApp::before {
            ...
            opacity: .32;
            background-image:
                radial-gradient(circle, rgba(9,45,63,.07) 0 1.2px, transparent 1.4px),
                linear-gradient(115deg, transparent 0 54%, rgba(255,255,255,.56) 54% 54.35%, transparent 54.35% 100%);
            background-size: 18px 18px, auto;
            mask-image: linear-gradient(to bottom, rgba(0,0,0,.95), rgba(0,0,0,.72) 72%, transparent 100%);
        }
        ...
        [data-testid="stHeader"] {
            ...
            border-bottom: 1px solid rgba(132, 157, 168, 0.28);
            backdrop-filter: blur(16px);
        }

        [data-testid="stSidebar"] {
            background:
                radial-gradient(circle at 12% 0%, rgba(63,183,214,.22), transparent 14rem),
                radial-gradient(circle at 88% 18%, rgba(118,200,185,.14), transparent 12rem),
                linear-gradient(180deg, #072839 0%, #0C3145 52%, #0A2737 100%);
            border-right: 1px solid rgba(142, 221, 230, 0.20);
            box-shadow: 18px 0 48px rgba(7, 31, 43, 0.20);
        }
        ...
        [data-testid="stSidebar"]::before {
            ...
            pointer-events: none;
            opacity: .16;
            background-image: radial-gradient(circle, rgba(255,255,255,.42) 0 1px, transparent 1.1px);
        ...
        .sidebar-brand {
            ...
            padding: .86rem .88rem;
            margin: 0 0 .8rem 0;
            border: 1px solid rgba(142,221,230,.22);
            border-radius: 18px;
        ...
        .sidebar-brand::before {
            ...
            inset: 0;
            opacity: .18;
            background-image: linear-gradient(135deg, transparent 0 48%, rgba(255,255,255,.22) 48% 49%, transparent 49% 100%);
        }
        ...
        .sidebar-mark {
            ...
            border-radius: 13px;
            color: #FFFFFF;
            background: linear-gradient(145deg, #49BEDC, #0A7BA4 72%, #1E9B92 100%);
            font-weight: 900;
            box-shadow: 0 12px 24px rgba(18,137,179,.32);
        }
        ...
        .sidebar-version {
            ...
            border-radius: 12px;
            color: #D4F7FA;
            background: linear-gradient(145deg, rgba(63,183,214,.15), rgba(118,200,185,.09));
            border: 1px solid rgba(142,221,230,.16);
            font-size: .76rem;
            font-weight: 760;
            text-align: center;
        ...
        .durlum-header {
            ...
            align-items: stretch;
            min-height: 210px;
            margin: .05rem 0 .95rem 0;
            border: 1px solid rgba(112, 147, 162, 0.34);
            border-radius: 28px;
            background: linear-gradient(135deg, #072839 0%, #0E374C 45%, #0A2E40 100%);
        ...
        .durlum-header::before {
            ...
            inset: 0;
            opacity: .20;
            background-image: radial-gradient(circle, rgba(255,255,255,.85) 0 1px, transparent 1.15px);
            background-size: 18px 18px;
            mask-image: linear-gradient(90deg, transparent 0 42%, rgba(0,0,0,.9) 42% 100%);
        }
        ...
        .durlum-header::after {
            ...
            inset: auto 0 0 0;
            height: 4px;
            background: linear-gradient(90deg, transparent, var(--df-blue-2) 18%, var(--df-cyan) 46%, var(--df-teal-2) 67%, transparent);
            opacity: .9;
        }
        ...
        .durlum-hero-copy {
            ...
            display: flex;
            gap: 1rem;
            padding: 1.2rem 1.25rem 1.1rem 1.2rem;
        }
        ...
        .durlum-logo-box {
            ...
            background:
                ...
                linear-gradient(145deg, #35AED1, #0B7CA6 68%, #249C95 100%);
        ...
        .durlum-eyebrow-dot {
            ...
            height: 7px;
            border-radius: 50%;
            background: linear-gradient(145deg, #99E7F1, #47B8D6);
            box-shadow: 0 0 0 4px rgba(142,221,230,.10);
        }
        ...
        .page-spotlight {
            ...
            border: 1px solid rgba(155, 178, 189, .38);
            border-radius: 18px;
            background: linear-gradient(145deg, rgba(255,255,255,.86), rgba(242,247,248,.92));
        ...
        .page-spotlight::before {
            ...
            inset: 0;
            opacity: .22;
            background-image: linear-gradient(135deg, transparent 0 74%, rgba(63,183,214,.18) 74% 74.8%, transparent 74.8% 100%);
        }
        ...
        .page-spotlight-icon {
            ...
            border-radius: 13px;
            color: var(--df-blue);
            background: linear-gradient(145deg, #EAF5F8, #DCEEF4);
        ...
        h1, h2, h3 { color: var(--df-ink); letter-spacing: -.026em; }
        p, .stMarkdown, .stMarkdown p { color: var(--df-text); }

        [data-testid="stMetric"] {
            position: relative;
            overflow: hidden;
            min-height: 114px;
            padding: .96rem 1.02rem;
            border: 1px solid rgba(195, 210, 217, .92);
            border-radius: 18px;
            background: linear-gradient(145deg, rgba(255,255,255,.95), rgba(239,245,247,.96));
            box-shadow: var(--df-shadow-soft);
        ...
        [data-testid="stMetric"]::before {
            ...
            bottom: 0;
            width: 4px;
            background: linear-gradient(180deg, var(--df-blue), var(--df-teal));
        }
        ...
        [data-testid="stMetric"]::after {
            ...
            top: -60px;
            border-radius: 50%;
            background: radial-gradient(circle, rgba(63,183,214,.16), transparent 64%);
        }

        [data-testid="stMetric"]:hover {
            transform: translateY(-2px);
            box-shadow: 0 18px 38px rgba(10, 42, 58, 0.12);
        }
        ...
        .wizard-shell {
            ...
            border-radius: 18px;
            background: linear-gradient(145deg, rgba(232,239,242,.94), rgba(244,248,249,.96));
            box-shadow: var(--df-shadow-soft);
        }
        ...
        .wizard-step.done .wizard-step-number {
            color: #FFFFFF;
            background: linear-gradient(145deg, #2D9F7A, #257D67);
        }
        ...
        .wizard-step.active {
            ...
            border-color: #A7CBD8;
            box-shadow: inset 0 -3px 0 var(--df-blue), 0 8px 22px rgba(10,42,58,.08);
        }

        .wizard-step.active .wizard-step-number {
            color: #FFFFFF;
            background: linear-gradient(145deg, #1AA2CB, #0F88B3);
        }

        .wizard-panel,
        .review-card,
        .insight-card {
            border: 1px solid rgba(198, 212, 219, .96);
            background: linear-gradient(145deg, rgba(255,255,255,.95), rgba(239,244,246,.96));
            box-shadow: var(--df-shadow-soft);
        }
        ...
        .wizard-panel::after {
            ...
            height: 120px;
            border-radius: 50%;
            background: radial-gradient(circle, rgba(74,174,159,.10), transparent 65%);
        }
        ...
        .review-item {
            ...
            border-radius: 12px;
            background: linear-gradient(145deg, rgba(234,241,244,.82), rgba(249,251,252,.92));
        }
        ...
        .notification-card {
            ...
            border-radius: 14px;
            background: linear-gradient(145deg, rgba(240,245,247,.92), rgba(251,252,253,.96));
            box-shadow: var(--df-shadow-soft);
        }
        ...
        .notification-card::before {
            ...
            inset: 0 auto 0 0;
            width: 4px;
            background: linear-gradient(180deg, var(--df-blue-2), var(--df-teal));
        }
        ...
        .empty-state {
            ...
            padding: 1.4rem;
            text-align: center;
            border: 1px dashed #B3C8D0;
            border-radius: 20px;
            background:
                radial-gradient(circle at 50% 0%, rgba(63,183,214,.10), transparent 13rem),
                linear-gradient(145deg, rgba(250,252,252,.96), rgba(240,246,247,.90));
        }
        ...
        .empty-icon {
            ...
            border-radius: 16px;
            color: var(--df-blue);
            background: linear-gradient(145deg, #E4F2F6, #DAEEF3);
            font-size: 1.5rem;
        }
        ...
        .completed-state {
            ...
            border-radius: 16px;
            color: #276F58;
            background: linear-gradient(145deg, #E5F3EC, #EDF8F3);
            box-shadow: var(--df-shadow-soft);
        }
        ...
        .insight-card::after {
            ...
            top: -54px;
            border-radius: 50%;
            background: radial-gradient(circle, rgba(63,183,214,.12), transparent 70%);
        }
        ...
        .product-footer {
            ...
            border-radius: 16px;
            color: var(--df-muted);
            background: linear-gradient(145deg, rgba(255,255,255,.78), rgba(239,245,247,.86));
            text-align: center;
            font-size: .76rem;
            box-shadow: var(--df-shadow-soft);
        }
        ...
        [data-testid="baseButton-primary"] {
            ...
            background: linear-gradient(145deg, #FFFFFF, #F0F5F6) !important;
            color: var(--df-ink) !important;
            box-shadow: 0 8px 18px rgba(10,42,58,.06);
        ...
        [data-testid="baseButton-primary"]:hover {
            ...
            box-shadow: 0 14px 26px rgba(10,42,58,.10);
        }

        [data-testid="baseButton-primary"] {
            background: linear-gradient(145deg, #1AA2CB, #0F88B3 72%, #269D98 100%) !important;
            color: #FFFFFF !important;
            border-color: #0F88B3 !important;
        }
        ...
        .stDataFrame, [data-testid="stTable"] {
            border: 1px solid rgba(198, 212, 219, .95);
            border-radius: 18px;
            overflow: hidden;
            box-shadow: var(--df-shadow-soft);
        ...
        .area-blueprint {
            ...
            min-height: 220px;
            padding: 1rem;
            border: 1px solid rgba(171, 197, 207, .96);
            border-radius: 20px;
            color: #EAFBFD;
            background:
                radial-gradient(circle, rgba(255,255,255,.12) 0 1px, transparent 1.2px),
                linear-gradient(rgba(142,221,230,.065) 1px, transparent 1px),
                linear-gradient(90deg, rgba(142,221,230,.065) 1px, transparent 1px),
                linear-gradient(145deg, #082B3D, #0E3950 68%, #0A2F42);
        ...
        .sheet-diagram {
            ...
            border: 2px solid rgba(210,244,251,.82);
            background: linear-gradient(135deg, rgba(255,255,255,.06), rgba(142,221,230,.15));
            box-shadow: inset 0 0 0 8px rgba(142,221,230,.035), 0 12px 26px rgba(0,0,0,.12);
        }
        ...
        .dimension-x { left: 50%; bottom: -20px; transform: translateX(-50%); }
        .dimension-y { left: -54px; top: 50%; transform: translateY(-50%) rotate(-90deg); }
        ...
        .area-stage {
            display: grid;
            grid-template-columns: minmax(320px, .95fr) minmax(0, 1.12fr);
            gap: .86rem;
            align-items: stretch;
        ...
        .area-stat-card {
            ...
            min-height: 108px;
            padding: .82rem .86rem;
            border: 1px solid rgba(196, 210, 217, .95);
            border-radius: 16px;
            background: linear-gradient(145deg, rgba(255,255,255,.96), rgba(239,245,247,.95));
            box-shadow: var(--df-shadow-soft);
        }
        ...
        .area-stat-card::before {
            ...
            inset: 0 auto 0 0;
            width: 4px;
            background: linear-gradient(180deg, #1AA2CB, #269D98);
        }

        .area-stat-card.completion-card::before {
            background: linear-gradient(180deg, #269D98, #37C0A8);
        }
        ...
        .completion-ring {
            ...
            font-size: .95rem;
            font-weight: 900;
            background: conic-gradient(#43B7D5 calc(var(--pct, 0) * 1%), rgba(210,225,232,.72) 0);
            box-shadow: inset 0 0 0 10px rgba(255,255,255,.96);
        }
        ...
        .area-summary-item {
            ...
            border-radius: 16px;
            background: linear-gradient(145deg, rgba(231,240,243,.95), rgba(251,252,252,.95));
            box-shadow: var(--df-shadow-soft);
        }
        ...
        .area-summary-item::before {
            ...
            inset: 0 auto 0 0;
            width: 4px;
            background: linear-gradient(180deg, #4EB9D8, #1A90B8);
        }
        ...
        @media (max-width: 980px) {
            .durlum-header { grid-template-columns: 1fr; }
            .hero-art { display: none; }
            .area-stage { grid-template-columns: 1fr; }
        }
        ...
        @media (max-width: 900px) {
            ...
            .durlum-header-side { flex-direction: column; align-items: flex-start; }
            .durlum-title { font-size: 2.02rem; }
            .review-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }
            .wizard-shell { grid-template-columns: repeat(2, minmax(0, 1fr)); }
        ...
        /* SIDEBAR BİLDİRİM MERKEZİ OKUNABİLİRLİĞİ */
        [data-testid="stSidebar"] [data-testid="stExpander"] {
            background: rgba(255, 255, 255, 0.055) !important;
            border-color: rgba(142, 217, 233, 0.20) !important;
        ...
        [data-testid="stSidebar"] .notification-card {
            background: linear-gradient(145deg, rgba(255,255,255,.13), rgba(142,217,233,.05)) !important;
            border-color: rgba(184, 225, 236, 0.24) !important;
            box-shadow: none !important;
        }

        [data-testid="stSidebar"] .notification-title,
        [data-testid="stSidebar"] .notification-title *,
        [data-testid="stSidebar"] .notification-card strong {
            color: #FFFFFF !important;
            opacity: 1 !important;
        }
            ...
            <div class="durlum-hero-copy">
                ...
                <div>
                    ...
                    <h1 class="durlum-title">
                        Üretim <span>Akışı</span> ve Operasyon Tasarımı
                    </h1>
                    <div class="durlum-subtitle">
                        Mesh tavan, metal yüzey ve modüler üretim mantığından ilham alan
                        bu dijital merkez; OC, POS, operasyon, verim ve fire süreçlerini
                        tek bir mimari kontrol katmanında birleştirir.
                    </div>
                ...
                <svg viewBox="0 0 560 260" preserveAspectRatio="xMidYMid slice">
                    <defs>
                        <linearGradient id="meshLine" x1="0" x2="1">
                            <stop offset="0" stop-color="#8EDDE6" stop-opacity=".85"/>
                            <stop offset=".5" stop-color="#47B8D6" stop-opacity=".45"/>
                            <stop offset="1" stop-color="#6FC7B8" stop-opacity=".65"/>
                        </linearGradient>
                        <linearGradient id="panelGlow" x1="0" x2="1">
                            <stop offset="0" stop-color="#FFFFFF" stop-opacity=".06"/>
                            <stop offset="1" stop-color="#8EDDE6" stop-opacity=".28"/>
                        </linearGradient>
                        <filter id="heroBlur">
                    ...
                    <circle cx="470" cy="45" r="88" fill="#47B8D6" opacity=".12" filter="url(#heroBlur)"/>
                    <circle cx="360" cy="180" r="96" fill="#6FC7B8" opacity=".10" filter="url(#heroBlur)"/>

                    <g transform="translate(36,30)">
                        <rect x="32" y="18" width="162" height="88" rx="18" fill="url(#panelGlow)" stroke="#C9F0F6" stroke-opacity=".40"/>
                        <rect x="172" y="82" width="186" height="92" rx="18" fill="url(#panelGlow)" stroke="#D9F7FB" stroke-opacity=".26"/>
                        <rect x="294" y="16" width="180" height="74" rx="18" fill="url(#panelGlow)" stroke="#BCEBF2" stroke-opacity=".28"/>

                        <g fill="none" stroke="url(#meshLine)" stroke-opacity=".62">
                            <path d="M0 176 H496" stroke-width="1.5"/>
                            <path d="M18 192 H512" stroke-width="1"/>
                            <path d="M54 20 L214 176" stroke-width="1.4"/>
                            <path d="M122 20 L282 176" stroke-width="1.2"/>
                            <path d="M190 20 L350 176" stroke-width="1.2"/>
                            <path d="M258 20 L418 176" stroke-width="1.2"/>
                            <path d="M326 20 L486 176" stroke-width="1.2"/>
                            <path d="M394 20 L554 176" stroke-width="1.2"/>
                        </g>

                        <g fill="#DBF6FB" opacity=".55">
                            <circle cx="110" cy="60" r="2.6"/>
                            <circle cx="140" cy="90" r="2.6"/>
                            <circle cx="170" cy="120" r="2.6"/>
                            <circle cx="200" cy="150" r="2.6"/>
                            <circle cx="255" cy="58" r="2.6"/>
                            <circle cx="288" cy="88" r="2.6"/>
                            <circle cx="320" cy="118" r="2.6"/>
                            <circle cx="352" cy="148" r="2.6"/>
                            <circle cx="404" cy="56" r="2.6"/>
                            <circle cx="438" cy="86" r="2.6"/>
                            <circle cx="470" cy="116" r="2.6"/>
                            <circle cx="502" cy="146" r="2.6"/>
                        </g>

                        <g fill="none" stroke="#D9F7FB" stroke-opacity=".20">
                            <rect x="62" y="44" width="100" height="36" rx="8"/>
                            <rect x="196" y="108" width="122" height="38" rx="8"/>
                            <rect x="326" y="38" width="108" height="30" rx="8"/>
                        </g>
                    </g>
                </svg>
            </div>
...
def main():
    ...
    st.caption("Sürüm 2.13 · DURLUM VISUAL IDENTITY PACK · İşçi, OC, POS, işlem, adet, fire ve yetkinlik takibi")
    if is_manager:
    ...
    with st.sidebar:
        st.markdown(
            ...
            <div class="sidebar-version">
                Sürüm 2.12.7.1 · GRAFİK DÜZELTMESİ
            </div>
            """,
            unsafe_allow_html=True,
        )
