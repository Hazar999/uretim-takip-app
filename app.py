...
def apply_durlum_theme():
    ...
    st.markdown(
        ...
        /* BİLDİRİM MERKEZİ — KOYU SIDEBAR İÇİN YÜKSEK OKUNABİLİRLİK */
        ...
        [data-testid="stSidebar"] .notification-card .status-pill.blue {
            color: #BEEFFF !important;
            background: rgba(55, 181, 220, .20) !important;
            border-color: rgba(142, 217, 233, .28) !important;
        }

        [data-testid="stSidebar"] .notification-card .status-pill.green {
            color: #C7F5E3 !important;
            background: rgba(47, 140, 106, .22) !important;
            border-color: rgba(99, 214, 176, .28) !important;
        }

        [data-testid="stSidebar"] .notification-card .status-pill.orange {
            color: #FFE4B0 !important;
            background: rgba(166, 106, 32, .24) !important;
            border-color: rgba(238, 190, 117, .28) !important;
        }

        [data-testid="stSidebar"] .notification-card .status-pill.red {
            color: #FFD2D6 !important;
            background: rgba(182, 76, 87, .25) !important;
            border-color: rgba(236, 150, 159, .30) !important;
        }

        [data-testid="stSidebar"] .notification-card .status-pill.purple {
            color: #E1DCFF !important;
            background: rgba(110, 100, 166, .26) !important;
            border-color: rgba(190, 181, 238, .28) !important;
        }

        [data-testid="stSidebar"] .notification-card .status-pill.gray {
            color: #E0EBEF !important;
            background: rgba(185, 205, 214, .14) !important;
            border-color: rgba(202, 221, 229, .20) !important;
        }
...
def main():
    ...
    st.caption("Sürüm 2.12.7 PROFESYONEL ÜRETİM SÜRÜMÜ · İşçi, OC, POS, işlem, adet, fire ve yetkinlik takibi")
    if is_manager:
    ...
    with st.sidebar:
        st.markdown(
            ...
            <div class="sidebar-version">
                Sürüm 2.12.7 · PROFESYONEL ÜRETİM SÜRÜMÜ
            </div>
            """,
            unsafe_allow_html=True,
        )
