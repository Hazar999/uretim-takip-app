...
def apply_durlum_theme():
    """Durlum renkleriyle modern, göz alıcı ve dokunmatik kullanıma uygun arayüz."""
    st.markdown(
        """
        <style>
        :root {
            --d-blue: #00A6D6;
            --d-blue-bright: #31D5FF;
            --d-blue-deep: #007EA8;
            --d-cyan-soft: rgba(49, 213, 255, 0.12);
            --d-navy-950: #03101A;
            --d-navy-900: #061824;
            --d-navy-850: #092132;
            --d-navy-800: #0D2B3E;
            --d-panel: rgba(12, 40, 57, 0.86);
            --d-panel-strong: rgba(14, 47, 67, 0.96);
            --d-line: rgba(81, 213, 245, 0.22);
            --d-line-strong: rgba(81, 213, 245, 0.42);
            --d-text: #F4FBFF;
            --d-muted: #A7BFCC;
            --d-success: #31D49B;
            --d-warning: #FFBE55;
            --d-danger: #FF6775;
            --d-purple: #8B8CFF;
            --d-shadow: 0 24px 65px rgba(0, 0, 0, 0.30);
            --d-shadow-soft: 0 12px 32px rgba(0, 0, 0, 0.20);
        }
        ...
        .stApp {
            color: var(--d-text);
            background:
                radial-gradient(circle at 82% 2%, rgba(0, 166, 214, 0.25), transparent 27rem),
                radial-gradient(circle at 12% 88%, rgba(49, 213, 255, 0.10), transparent 32rem),
                linear-gradient(135deg, #020C14 0%, #061824 42%, #092535 100%);
        ...
        .stApp::before {
            ...
            opacity: 0.22;
            background-image:
                linear-gradient(rgba(49, 213, 255, 0.035) 1px, transparent 1px),
                linear-gradient(90deg, rgba(49, 213, 255, 0.035) 1px, transparent 1px);
        ...
        [data-testid="stSidebar"] {
            background:
                radial-gradient(circle at 20% 0%, rgba(0, 166, 214, 0.22), transparent 17rem),
                linear-gradient(180deg, #04121D 0%, #071D2B 54%, #051621 100%);
        ...
        .sidebar-brand {
            ...
            border-radius: 15px;
            background: linear-gradient(135deg, rgba(0, 166, 214, 0.18), rgba(255,255,255,0.03));
        ...
        .sidebar-mark {
            ...
            place-items: center;
            border-radius: 11px;
            background: linear-gradient(135deg, var(--d-blue-bright), var(--d-blue-deep));
            color: #02131D;
            font-weight: 900;
            box-shadow: 0 9px 20px rgba(0, 166, 214, 0.30);
        }
        ...
        .durlum-header {
            ...
            border-radius: 24px;
            background:
                linear-gradient(115deg, rgba(0, 166, 214, 0.26), rgba(12, 40, 57, 0.90) 45%, rgba(3, 16, 26, 0.96));
        ...
        .durlum-header::before {
            ...
            top: -150px;
            border-radius: 50%;
            background: radial-gradient(circle, rgba(49, 213, 255, 0.36), transparent 68%);
        }
        ...
        .durlum-header::after {
            ...
            inset: auto 0 0 0;
            height: 3px;
            background: linear-gradient(90deg, transparent, var(--d-blue-bright), transparent);
            opacity: 0.75;
        }
        ...
        .durlum-logo-box {
            ...
            border-radius: 19px;
            background:
                linear-gradient(145deg, #5BE2FF 0%, #00A6D6 45%, #006D91 100%);
            color: #02131D;
            font-weight: 950;
            font-size: 1.2rem;
            line-height: 0.88;
            ...
            box-shadow:
                0 17px 35px rgba(0, 166, 214, 0.34),
        ...
        .durlum-eyebrow-dot {
            ...
            box-shadow: 0 0 14px rgba(49, 212, 155, 0.90);
        }
        ...
        .durlum-role {
            ...
            border-radius: 999px;
            border: 1px solid rgba(49, 213, 255, 0.25);
        ...
        .page-spotlight {
            ...
            border: 1px solid rgba(49, 213, 255, 0.20);
            border-radius: 17px;
            background: linear-gradient(110deg, rgba(49, 213, 255, 0.10), rgba(255,255,255,0.025));
            box-shadow: var(--d-shadow-soft);
        }
        ...
        .page-spotlight-icon {
            ...
            border: 1px solid rgba(49, 213, 255, 0.28);
        }
        ...
        [data-testid="stMetric"] {
            ...
            min-height: 112px;
            background:
                linear-gradient(145deg, rgba(18, 57, 78, 0.96), rgba(7, 28, 42, 0.96));
            border: 1px solid var(--d-line);
            border-radius: 18px;
        ...
        [data-testid="stMetric"]::before {
            ...
            inset: 0 0 auto 0;
            height: 3px;
            background: linear-gradient(90deg, var(--d-blue), var(--d-blue-bright), transparent);
        }
        ...
        [data-testid="stFormSubmitButton"] > button {
            ...
            background:
                linear-gradient(135deg, #33D7FF 0%, #00A6D6 52%, #00789F 100%);
            color: #00151F;
            font-weight: 850;
            letter-spacing: 0.01em;
            box-shadow:
                0 10px 22px rgba(0, 127, 168, 0.30),
        ...
        [data-testid="stFormSubmitButton"] > button:hover {
            ...
            transform: translateY(-2px);
            box-shadow:
                0 15px 30px rgba(0, 127, 168, 0.38),
        ...
        [data-testid="stTextArea"] textarea {
            background:
                linear-gradient(145deg, rgba(18, 51, 70, 0.94), rgba(9, 33, 49, 0.96)) !important;
            border-color: rgba(81, 213, 245, 0.22) !important;
        ...
        div[data-baseweb="textarea"] > div:hover {
            border-color: rgba(81, 213, 245, 0.42) !important;
        }

        div[data-baseweb="select"] > div:focus-within,
        div[data-baseweb="input"] > div:focus-within,
        div[data-baseweb="textarea"] > div:focus-within {
            border-color: var(--d-blue-bright) !important;
            box-shadow: 0 0 0 2px rgba(49, 213, 255, 0.12) !important;
        }
        ...
        [data-testid="stTable"] {
            ...
            border-radius: 17px;
            overflow: hidden;
            background: rgba(8, 29, 43, 0.88);
            box-shadow: var(--d-shadow-soft);
        }

        [data-testid="stDataFrame"] [role="columnheader"] {
            background: rgba(0, 166, 214, 0.13) !important;
        ...
        [data-baseweb="tab-list"] {
            ...
            padding: 0.28rem;
            border-radius: 14px;
            background: rgba(11, 38, 55, 0.82);
            border: 1px solid rgba(49, 213, 255, 0.10);
        }
        ...
        [aria-selected="true"][data-baseweb="tab"] {
            ...
            background: linear-gradient(135deg, var(--d-blue-bright), var(--d-blue));
            box-shadow: 0 8px 18px rgba(0, 166, 214, 0.22);
        }

        [data-testid="stExpander"] {
            border: 1px solid var(--d-line);
            border-radius: 15px;
            background: rgba(9, 32, 47, 0.82);
            overflow: hidden;
        ...
        [data-testid="stAlert"] {
            border-radius: 15px;
            border: 1px solid rgba(81, 213, 245, 0.16);
            box-shadow: 0 9px 22px rgba(0,0,0,.12);
        }

        [data-testid="stFileUploaderDropzone"] {
            border: 1.6px dashed rgba(81, 213, 245, 0.52);
            border-radius: 15px;
        ...
        [data-testid="stFileUploaderDropzone"]:hover {
            border-color: var(--d-blue-bright);
            background: rgba(0, 166, 214, 0.12);
        }

        [data-testid="stProgressBar"] > div > div {
            background: linear-gradient(90deg, var(--d-blue), var(--d-blue-bright)) !important;
        }
        ...
        [data-testid="stSidebar"] .stRadio label:has(input:checked) {
            background: linear-gradient(90deg, rgba(0, 166, 214, 0.22), rgba(0,166,214,.07));
            border-color: rgba(49, 213, 255, 0.25);
            box-shadow: inset 3px 0 0 var(--d-blue-bright);
        }
        ...
        .durlum-status-success {
            color: #C6F9E5;
            background: rgba(49, 212, 155, 0.13);
            border: 1px solid rgba(49, 212, 155, 0.32);
        }
        ...
        .durlum-status-danger {
            color: #FFC7CD;
            background: rgba(255, 103, 117, 0.13);
            border: 1px solid rgba(255, 103, 117, 0.32);
        }

        @keyframes durlumGlow {
            0%, 100% { box-shadow: 0 0 0 rgba(49, 213, 255, 0); }
            50% { box-shadow: 0 0 28px rgba(49, 213, 255, 0.14); }
        }

        .durlum-header {
            animation: durlumGlow 5s ease-in-out infinite;
        }
        ...
        .demo-banner {
            ...
            border-radius: 14px;
            color: #E8E4FF;
            background: linear-gradient(100deg, rgba(139, 140, 255, 0.18), rgba(0, 166, 214, 0.08));
        ...
        .wizard-step {
            position: relative;
            min-height: 68px;
            padding: 0.62rem 0.62rem 0.56rem 0.62rem;
            border-radius: 12px;
            border: 1px solid transparent;
            color: #829EAD;
        ...
        .wizard-step.done {
            color: #BFF8E3;
            background: rgba(49, 212, 155, 0.08);
            border-color: rgba(49, 212, 155, 0.20);
        }
        ...
        .wizard-step.active {
            color: #FFFFFF;
            transform: translateY(-2px);
            background: linear-gradient(145deg, rgba(0,166,214,.26), rgba(49,213,255,.08));
        ...
        .wizard-step.active .wizard-step-number {
            color: #00151F;
            background: linear-gradient(135deg, var(--d-blue-bright), var(--d-blue));
            box-shadow: 0 0 18px rgba(49,213,255,.36);
        }
        ...
        .wizard-panel {
            ...
            margin-bottom: 1rem;
            border-radius: 18px;
            background: linear-gradient(145deg, rgba(14,47,67,.91), rgba(7,28,42,.94));
            border: 1px solid rgba(49,213,255,.18);
        ...
        .review-card {
            ...
            border-radius: 18px;
            background:
                linear-gradient(145deg, rgba(13, 51, 72, 0.96), rgba(6, 25, 38, 0.96));
            border: 1px solid rgba(49, 213, 255, 0.28);
        ...
        .status-pill.blue {
            ...
            border-color: rgba(49,213,255,.28);
        }
        .status-pill.green {
            color: #C8FAE6;
            background: rgba(49,212,155,.13);
            border-color: rgba(49,212,155,.30);
        }
        .status-pill.orange {
            color: #FFE3B0;
        ...
        .status-pill.red {
            color: #FFC9CE;
            background: rgba(255,103,117,.13);
            border-color: rgba(255,103,117,.30);
        }
        .status-pill.purple {
            color: #E2DEFF;
            background: rgba(139,140,255,.14);
            border-color: rgba(139,140,255,.30);
        }
        .status-pill.gray {
            color: #C2D1D9;
            background: rgba(167,191,204,.09);
            border-color: rgba(167,191,204,.20);
        }
        ...
        .empty-state {
            ...
            border-radius: 22px;
            background:
                radial-gradient(circle at 50% 0%, rgba(49,213,255,.13), transparent 14rem),
                linear-gradient(145deg, rgba(12,40,57,.82), rgba(5,23,35,.88));
            border: 1px dashed rgba(49,213,255,.28);
        ...
        .empty-icon {
            ...
            font-size: 1.8rem;
            background: linear-gradient(135deg, var(--d-blue-bright), var(--d-blue));
            box-shadow: 0 14px 30px rgba(0,166,214,.26);
        }
        ...
        .completed-state {
            ...
            border-radius: 17px;
            color: #D2FBEA;
            background: linear-gradient(110deg, rgba(49,212,155,.16), rgba(0,166,214,.07));
            border: 1px solid rgba(49,212,155,.30);
        ...
        .insight-card {
            ...
            border-radius: 15px;
            background: linear-gradient(145deg, rgba(16,52,71,.91), rgba(7,29,43,.94));
            border: 1px solid rgba(49,213,255,.16);
            box-shadow: 0 10px 26px rgba(0,0,0,.16);
        }

        .insight-icon { font-size: 1.15rem; }
        .insight-title {
            margin-top: 0.38rem;
            color: #FFFFFF;
            font-size: 0.82rem;
        ...
        .product-footer {
            ...
            border-top: 1px solid rgba(49,213,255,.13);
            color: #7693A2;
            font-size: 0.72rem;
        }

        .product-footer strong { color: #BDEFFF; }
        ...
        <div class="durlum-header">
            <div class="durlum-brand">
                ...
                <div>
                    ...
                    <div class="product-ribbon">DURLUM FLOW · PRODUCTION INTELLIGENCE</div>
                    <h1 class="durlum-title">
                        Operasyon <span>Kontrol</span> Sistemi
                    </h1>
                    <div class="durlum-subtitle">
                        Üretim akışını görünür, ölçülebilir ve yönetilebilir hâle getiren dijital operasyon sistemi
                    </div>
                </div>
            </div>
...
def make_demo_operation_history() -> pd.DataFrame:
    ...
    rows = []
    operations = ["laser", "abkant", "kaynak", "boya", "paketleme"]
    workers = ["Azamat Remetov", "Yusuf Ay", "Sadettin Şeker"]
    batch_id = 9000
    for day_index in range(7):
        production_date = today - pd.Timedelta(days=6 - day_index)
        for op_index, operation in enumerate(operations):
            good = 20 + day_index * 3 + op_index * 2
            fire = 1 if (day_index + op_index) % 4 == 0 else 0
            processed = good + fire
            area = good * (820000 + op_index * 75000)
            rows.append({
                "batch_id": batch_id,
                "item_id": 7000 + op_index,
                "tarih": str(production_date.date()),
                "operator_ismi": workers[(day_index + op_index) % len(workers)],
                "calisma_tipi": "Mesaili" if day_index == 6 and op_index == 2 else "Tam zamanlı",
                "calisma_saati": 8.5 + (0.5 if op_index % 2 else 0),
                "OC": "940160",
                "POS": f"POS{(op_index + 1) * 10}",
                "operasyon": operation,
                "islem_yapilan": processed,
                "fire": fire,
                "saglam_ilerleyen": good,
                "unit_area_mm2": 820000 + op_index * 75000,
                "saglam_alan_mm2": area,
                "islenen_alan_mm2": processed * (820000 + op_index * 75000),
                "hedef_adet_saat": 3.2 + op_index * 0.25,
                "hedef_mm2_saat": 2700000 + op_index * 180000,
                "fire_siniri_yuzde": 5.0,
...
def main():
    ...
    st.caption("Sürüm 2.12 PRODUCT EXPERIENCE · İşçi, OC, POS, işlem, adet, fire ve yetkinlik takibi")
    if is_manager:
    ...
    with st.sidebar:
        ...
        st.checkbox(
            ...
            key="demo_mode",
            help="Sunum sırasında arayüzü deneyebilirsin; kayıtlar veritabanına yazılmaz.",
        )
        if st.session_state.get("demo_mode", False):
            st.caption("◆ Güvenli sunum modu: kayıt işlemleri simüle edilir.")
        if is_manager:
...
def yeni_kayit_page(reasons, combinations, is_manager: bool):
    ...
    def current_work_hours() -> float:
        current_type = str(st.session_state.get(type_key, "Tam zamanlı"))
        hours_key = f"op_hours_{current_type}_{version}"
        defaults = {"Tam zamanlı": 9.0, "Yarı zamanlı": 6.0, "Mesaili": 10.0}
        return float(st.session_state.get(hours_key, defaults.get(current_type, 9.0)))

    def resolve_selected_context():
        selected_label = st.session_state.get(oc_key, oc_labels[0] if oc_labels else "")
        selected_oc = oc_map.get(selected_label, oc_table["oc_no"].astype(str).iloc[0])
        oc_items = get_production_output_summary(selected_oc)
        positions_key = f"op_positions_{selected_oc}_{version}"
        positions = list(st.session_state.get(positions_key, []))
    ...
    def resolve_plans(selected_oc: str, selected_items: pd.DataFrame):
        ...
        change_plan = bool(st.session_state.get(change_key, False)) if is_manager else False
        combo_key = f"op_combo_{selected_oc}_{version}"
        selected_combo = st.session_state.get(combo_key, combo_names[0] if combo_names else None)
        plans = {}
        for _, item in selected_items.iterrows():
            item_id = int(item["item_id"])
    ...
    def resolve_operation_choices(
        ...
        show_other = bool(st.session_state.get(show_other_key, False))
        ...
        same_operations = bool(st.session_state.get(same_key, True))
        selected_map = {}
        if same_operations:
            common_key = f"common_ops_{selected_oc}_{version}"
            common = list(st.session_state.get(common_key, []))
            for _, item in selected_items.iterrows():
                item_id = int(item["item_id"])
                available = allowed(plans[item_id]["operations"])
                selected_map[item_id] = [op for op in common if op in available]
        else:
            for _, item in selected_items.iterrows():
                item_id = int(item["item_id"])
                ops_key = f"ops_{item_id}_{version}"
                selected_map[item_id] = list(st.session_state.get(ops_key, []))
    ...
    def build_entries(selected_items: pd.DataFrame, plans: dict, selected_map: dict):
        ...
        for _, item in selected_items.iterrows():
            ...
            for operation in selected_map.get(item_id, []):
                ...
                processed = int(st.session_state.get(processed_key, 0))
                fire = int(st.session_state.get(fire_key, 0))
                if processed > 0:
                    entries.append({
                        "item_id": item_id,
                        "pos": str(item["pos"]),
    ...
    operator_name = str(st.session_state.get(worker_key, ""))
    ...
    if step == 3:
        ...
        same_operations = st.checkbox(
            ...
            value=bool(st.session_state.get(f"same_operations_{selected_oc}_{version}", True)),
        ...
        if same_operations:
            ...
            for _, item in selected_items.sort_values("_sort_pos").iterrows():
                ...
                st.multiselect(
                    ...
                    allowed_for_plan(plans[item_id]["operations"]),
    ...
    if step == 4:
        ...
        m4.metric("Sağlam alan", f"{_format_mm2(performance['total_good_area_mm2'])} mm²")
        v1, v2, v3, v4 = st.columns(4)
        v1.metric("Adet / saat", f"{performance['qty_per_hour']:.2f}")
        v2.metric("mm² / saat", f"{_format_mm2(performance['area_per_hour'])}")
        v3.metric("Fire oranı", f"%{performance['fire_rate_pct']:.2f}")
        v4.metric(
            "Gidişat",
            performance["status"],
            delta=(
        ...
        with b2:
            if st.button("Kayıt Özetini Gör →", type="primary", use_container_width=True):
                ...
                if int(performance["total_fire"]) > 0 and not str(st.session_state.get(fire_note_key, "")).strip():
    ...
    entries = build_entries(selected_items, plans, selected_map)
    work_type = str(st.session_state.get(type_key, "Tam zamanlı"))
    production_date = st.session_state.get(date_key, date.today())
    reason = str(st.session_state.get(reason_key, ""))
    work_hours = current_work_hours()
    performance = calculate_entries_performance(entries, work_hours)
    fire_note = str(st.session_state.get(f"operation_fire_note_{version}", "")).strip()
    note = str(st.session_state.get(f"operation_note_{version}", "")).strip()
    ...
    for entry in entries:
        summary_rows.append({
            ...
            "Sağlam Alan mm²": entry["good_qty"] * entry["unit_area_mm2"],
        })
    st.dataframe(pd.DataFrame(summary_rows), use_container_width=True, hide_index=True)

    if fire_note:
        st.warning("Fire açıklaması: " + fire_note)
    if note:
    ...
    with b2:
        ...
        if st.button(
            ...
            if performance["total_fire"] > 0 and not fire_note:
                final_errors.append("Fire varsa kısa bir açıklama yazmalısın.")
            ...
            for entry in entries:
                entry["fire_note"] = fire_note if entry["fire_qty"] > 0 else ""

            if st.session_state.get("demo_mode", False):
                st.session_state.operation_form_version = version + 1
                st.session_state.operation_entry_success = (
                    f"Demo tamamlandı. {len(entries)} POS/işlem satırı simüle edildi; "
                    "gerçek veritabanına kayıt yazılmadı."
                )
                st.rerun()
...
def grafikler_page():
    ...
    history = get_operation_history()
    using_demo = False
    if history.empty and st.session_state.get("demo_mode", False):
        history = make_demo_operation_history()
        using_demo = True
    ...
    if history.empty:
        ...
        overview = get_operation_overview()
        if overview.empty and using_demo:
            overview = pd.DataFrame({
                "oc_no": ["940160"] * 5,
                "pos": ["POS10", "POS20", "POS30", "POS40", "POS50"],
                "completion_pct": [92, 78, 64, 48, 31],
                "remaining_qty": [2, 5, 8, 12, 18],
            })
